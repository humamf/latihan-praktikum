...
![lat1](https://user-images.githubusercontent.com/72872663/98061241-009e0280-1e7e-11eb-99e9-0aafce1731b7.png) <br>
...
![lat2](https://user-images.githubusercontent.com/72872663/98061243-01cf2f80-1e7e-11eb-9846-35a56c57836a.PNG) <br>
...
![lat3](https://user-images.githubusercontent.com/72872663/98061247-03005c80-1e7e-11eb-88e2-01688c13e863.PNG)
...
![lat4](https://user-images.githubusercontent.com/72872663/98061249-0398f300-1e7e-11eb-8d27-cf61c4929440.PNG)
<br>
<br>
<br>
...
![lab1(2)](https://user-images.githubusercontent.com/72872663/98086059-cbf76e80-1eb0-11eb-8673-f83f705e856d.PNG)
...
![lab1](https://user-images.githubusercontent.com/72872663/98086063-cc900500-1eb0-11eb-899c-dc07205353cc.PNG)
<br>
<br>
<br>
### Pertemuan 6 - lab 1-2 
...
![string 1](https://user-images.githubusercontent.com/72872663/98086085-d3b71300-1eb0-11eb-86e8-e6d18214569b.PNG)
...
``` python
print('{0:8} | {1:6}'.format('sepatu','Jumlah'))
print('{0:8} | {1:6}'.format('dalas', 3))
print('{0:8} | {1:6}'.format('NB',10))
```
Hasil dari source code contoh di atas akan seperti berikut : <br>
![string 2](https://user-images.githubusercontent.com/72872663/98086099-d4e84000-1eb0-11eb-9e97-deaafd4f82b3.PNG)
...
``` python
print('{:<25}{:^25}{:>25}'.format('Kiri','Tengah','Kanan'))
print('{:<25}{:^25}{:>25}'.format(10,30,50))
```
...
![string 2(2)](https://user-images.githubusercontent.com/72872663/98086094-d44fa980-1eb0-11eb-966b-d7e8f3e9ebfb.PNG)
<br>
<br>
...
![lab2](https://user-images.githubusercontent.com/72872663/98086067-cd289b80-1eb0-11eb-8bcf-114a9f8b572e.PNG)
<br>
<br>
